 ...
 * HAS PROBLEMS DUE TO BEING COMPOSED OF SEVERAL DECKS, NOT INDIVIDUAL CARDS
 */

//JDK 1.8.0

/****************************************************************************
 * <b>Title</b>: Shoe3.java <p/>
...
//	private ArrayList<Card> myDeck = new ArrayList<Card>();
	...
	public Shoe3(int deckType, boolean hasJokers) {
		this.deckType = deckType;
	...
	public Shoe3(int deckType, int numOfDecks, boolean hasJokers) {
		this.numOfDecks = numOfDecks;
		this.deckType = deckType;
		this.hasJokers = hasJokers;
		if (hasJokers == true) {
...
//		Collections.shuffle(comboDeck);
	...
	// Override toString() to print Shoe3 contents instead of hashcode for Shoe3
	@Override
	...
	public static void main(String[] args) {
		...
		Shoe3 testShoe = new Shoe3(1, true);
